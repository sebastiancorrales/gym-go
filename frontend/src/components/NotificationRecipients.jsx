...
const COLOR = {
  emerald: {
    badge:  'bg-[#EBF3FF] text-[#0D5BAD] border-[#C5DEFA]',
    icon:   'bg-[#EBF3FF] text-[#1272D6]',
    toggle: 'bg-[#EBF3FF]0',
    dot:    'bg-[#1272D6]',
  },
  blue: {
...
export default function NotificationRecipients({ onToast }) {
  ...
  const inputCls = (field) =>
    `w-full px-4 py-3 border rounded-xl text-sm focus:ring-2 focus:ring-[#1272D6] focus:border-transparent transition ${
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {!showForm && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-[#1272D6] border border-[#A7F3D0] rounded-xl hover:bg-[#EBF3FF] transition whitespace-nowrap flex-shrink-0"
          >
        ...
        >
          ...
          <div className="flex gap-2 pt-1">
            <button
              type="submit"
              disabled={adding}
              className="px-4 py-2 text-sm font-semibold bg-[#EBF3FF]0 hover:bg-[#1272D6] text-white rounded-xl transition disabled:opacity-50"
            >
                  ...
                  {list.map(r => (
                    <li key={r.id} className="flex items-center gap-3 px-4 py-3">
                      ...
                      <button
                        ...
                        className={`relative w-9 h-5 rounded-full transition-colors flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-[#1272D6] focus:ring-offset-1 disabled:opacity-50 ${
