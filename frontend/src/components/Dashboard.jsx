...
export default function Dashboard({ user, onLogout }) {
  ...
  useEffect(() => {
    // Simular datos de KPIs (en producción vendrían del API)
    setStats({
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button className="flex items-center space-x-3 p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition">
              ...
              <span className="font-medium text-gray-700">Nuevo Miembro</span>
            </button>
            <button className="flex items-center space-x-3 p-4 bg-green-50 hover:bg-green-100 rounded-lg transition">
              ...
              <span className="font-medium text-gray-700">Registrar Pago</span>
            </button>
            <button className="flex items-center space-x-3 p-4 bg-purple-50 hover:bg-purple-100 rounded-lg transition">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-800">Nueva suscripción</p>
                  <p className="text-sm text-gray-500">Juan Pérez - Plan Premium</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-gray-800">Acceso registrado</p>
                  <p className="text-sm text-gray-500">María García - Entrada</p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Carlos Rodríguez - $50.00</p>
                </div>
              </div>
