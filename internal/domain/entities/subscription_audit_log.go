...
type SubscriptionAuditLog struct {
	...
	SubscriptionID uuid.UUID `json:"subscription_id" gorm:"index:idx_sub_audit_sub,priority:1"`
	...
	CreatedAt      time.Time `json:"created_at" gorm:"index:idx_sub_audit_sub,priority:2"`
}
